...
export const footer: Footer = {
  ...
  WCGMarketsIsALimitedLiabilityCompany:
    'WCG Markets 是位於聖文森特和格林納丁斯依據國際商業公司法注冊的有限責任公司，公司編號為 26087 BC 2020。註冊地址是：The Financial Services Centre Stoney Ground, Kingstown, St.Vincent & the Grenadines.',
  WCGMarketsIsRegulatedByTheFINTRAC:
    'WCG Markets 獲加拿大金融情報部門(FIU)加拿大金融交易和報告分析中心(FINTRAC)監管，MSB牌照編號為 M20282836。註冊地址是： 150-10451 Shellbridge Way, Richmond BC V6X 2W8, Canada.',
  WCGGlobalLtd:
  ...
  restrictedAreas:
    '受限制地區：WCG Markets 的網站信息不針對加拿大的卑詩省、魁北克省和薩斯喀徹溫省地區、日本、朝鮮民主主義人民共和國（朝鮮）、伊朗、美國以及香港的居民；並且不向身處與發布或使用該信息有違當地法律法規的國家或管轄地之人發送或供其使用。'
};
