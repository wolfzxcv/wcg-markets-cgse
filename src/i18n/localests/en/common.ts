...
export const common: Common = {
  ...
  UseTheMostStable: 'Use the most stable MetaTrader trading system',
  WCGMarketsBringYouTheBest:
    'WCG MARKETS brings you the best market breadth and depth of liquidity. Working with a number of top liquidity providers to create an efficient and stable trading environment, which enables you to trade a wide range of markets at truly competitive prices.',
  PROVIDER: 'PROVIDER',
  ...
  mediaAwards3:
    'WCG MARKETS is always your wise choice for further learning about pattern analysis. The graph is a record of the outcome of this game. People have gradually discovered some typical chart patterns on the charts, with which one can clearly see whether the market is dominated by buyers or sellers. As these classic patterns appear over and over again, one finds that the same shifts in buyer and seller power are always present in the market. Therefore, we can use the experience of learning patterns to predict the trend of the market outlook, which is pattern analysis.',
  mediaAwards4:
    "WCG's mission is to provide clients with a more diverse, safe, transparent and fair trading environment, and to enter the global financial market through WCG's high-quality services.",
  mediaAwards5:
    'WCG keeps making progress with the generation. For this reason, we insist on investing in the latest technology, which not only makes auditing and account opening faster, but also provides a convenient payment system, deposit and withdrawal services to all customers.',
  mediaAwards6:
    'We use the latest bridging technology to connect MT4 and top liquidity providers, allowing clients to trade by mobile app and react instantly to market activity news and data.',
  mediaAwards7:
    'Adhering to our core principles of fairness and impartiality, we ensure fully automated execution of client transactions.',
  mediaAwards8:
