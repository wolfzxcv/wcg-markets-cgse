...
export const common: Common = {
  ...
  our: 'OUR',
  advantage: 'ADVANTAGE',
  TheChineseGoldAndSilverExchangeSociety:
  ...
  ofTheTotalAmountOfEachContract:
    'number% of the total amount of each contract',
  ...
  MetaTrader4WillAutomatically:
    'MetaTrader 4 will automatically close the positions in order from the largest loss position to the smallest loss position.',
  whenThePriceFluctuatesGreatly:
  ...
  ifTheMarginIsLess:
    'If the margin is less than 100% of the initial margin when the market closes before weekends and holidays, MetaTrader 4 will lock all positions (hedging).',
  marketInterest: 'Market interest',
  OneDayMarketPassingInterest:
